...
- Blocked:
  - None.
- Next action:
  - Continue `AnimationState` parity audit around C++ `computeHold`/timeline mode and remaining public control/query surfaces before attempting any `interruptAlpha`-shape refactor.
