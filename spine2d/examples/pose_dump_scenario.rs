...
fn debug_dump_bones(label: &str, skeleton: &Skeleton, total_time: f32) {
    ...
    for name in names {
        ...
        eprintln!(
            ...
            bone.get_applied_x(),
            bone.get_applied_y(),
            bone.get_applied_rotation(),
            bone.get_applied_scale_x(),
            bone.get_applied_scale_y(),
            bone.get_applied_shear_x(),
            bone.get_applied_shear_y(),
            bone.get_a(),
            bone.get_b(),
            bone.get_c(),
            bone.get_d(),
    ...
    let bones: Vec<_> = skeleton
        ...
        .map(|(i, bone)| {
            ...
            json!({
                ...
                "world": {"a": bone.get_a(), "b": bone.get_b(), "c": bone.get_c(), "d": bone.get_d(), "x": bone.get_world_x(), "y": bone.get_world_y()},
                "applied": {"x": bone.get_applied_x(), "y": bone.get_applied_y(), "rotation": bone.get_applied_rotation(), "scaleX": bone.get_applied_scale_x(), "scaleY": bone.get_applied_scale_y(), "shearX": bone.get_applied_shear_x(), "shearY": bone.get_applied_shear_y()},
            })
        })
        .collect();
